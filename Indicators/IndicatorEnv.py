...
tick = "GBPJPY"
dhOBJ = DataHandler()
rawData = dhOBJ.getDF(f"StockData/Raw/{tick}.csv").iloc[:5000]
print(rawData)
...
score, error, sampleSize, valDF = emaOBJ.validate(rawData, "1h", atrDF)
print(score, error, sampleSize)
print(valDF)
# print(score, valDF)

# atrDF.iloc[:, 0] = atrDF.iloc[:, 0] + 
